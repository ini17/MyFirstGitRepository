                    ...
                    <div class="col-sm-4 clone">
                        <div class="latest-post">
                            ...
                            <div class="l-post-info">
                                <i class="fa fa-user user-icons"></i><a href="<?php echo esc_url(get_author_posts_url(get_the_author_meta('ID'))); ?>"><?php  the_author(); ?> <i class="fa fa-clock-o user-icons"></i><?php the_date();?></a>
                            </div>
