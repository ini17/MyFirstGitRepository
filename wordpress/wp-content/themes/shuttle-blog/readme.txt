...
For support for Shuttle Blog please go to https://wordpress.org/support/theme/shuttle-blog.


== Installation ==

1. In your admin panel, go to Appearance -> Themes and click the 'Add New' button.
2. Type in Shuttle Blog in the search form and press the 'Enter' key on your keyboard.
...
Shuttle Blog WordPress Theme is child theme of Shuttle WordPress Theme, Copyright 2018 Shuttle Themes
Shuttle WordPress Theme is distributed under the terms of the GNU GPL.

Shuttle Blog WordPress Theme, Copyright 2019 Shuttle Themes
Shuttle Blog is distributed under the terms of the GNU GPL

Shuttle Blog is a child theme of Shuttle and as such uses the same opensource projects as its parent theme.
...
Shuttle Blog uses the following third-party resources:

https://www.pexels.com/photo/man-in-a-white-boat-in-sea-during-daytime-46257/
