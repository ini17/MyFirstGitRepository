            ...
            <div class="container text-center">
                <div class="copy">
                    ...
                    <?php else :
                        ...
                        /* translators: 1: poweredby, 2: link, 3: span tag closed  */
                        printf( esc_html__( ' Theme: powered by:WordPress %1$sDesign By %2$s%3$s', 'buildo' ), '<span>', '<a href="'. esc_url( __( 'https://wordpress.org/', 'buildo' ) ) .'" target="_blank">"'. esc_html('wpthemejungle','buildo'). '"</a>', '</span>' );
                    endif;  ?> 
                </div>
            </div>
        </div>
