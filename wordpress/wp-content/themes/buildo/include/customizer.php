...
function buildo_customize_register( $wp_customize ) {	
	 ...
	 * Important Link
	*/
	 class buildo_theme_info_text extends WP_Customize_Control{
	...
	$wp_customize->add_section( 'buildo_implink_section', array(
	  'title'       => esc_html__( 'Important Links', 'buildo' ),
	  'priority'      => 200
	) );

	    $wp_customize->add_setting( 'buildo_imp_links', array(
	      'sanitize_callback' => 'buildo_text_sanitize'
	    ));

	    $wp_customize->add_control( new buildo_theme_info_text( $wp_customize,'buildo_imp_links', array(
	        'settings'    => 'buildo_imp_links',
	        'section'   => 'buildo_implink_section',
	        'description' => '<a class="implink" href="http://wpthemejungle.com/docs/buildo-documentation/documentation.html" target="_blank">'.esc_html__('Documentation', 'buildo').'</a><a class="implink" href="http://wpthemejungle.com/product/premium-details/" target="_blank">'.esc_html__('Live Demo', 'buildo').'</a><a class="implink" href="https://wordpress.org/support/theme/buildo" target="_blank">'.esc_html__('Support Forum', 'buildo').'</a>',
	      )
	    ));

	    $wp_customize->add_setting( 'buildo_rate_us', array(
	      'sanitize_callback' => 'buildo_text_sanitize'
	    ));

	    $wp_customize->add_control( new buildo_theme_info_text( $wp_customize, 'buildo_rate_us', array(
	          'settings'    => 'buildo_rate_us',
	          'section'   => 'buildo_implink_section',
              /* translators: 1.text 2.theme */
	          'description' => sprintf(__( 'Please do rate our theme if you liked it %1$s', 'buildo'), '<a class="implink" href="https://wordpress.org/support/theme/buildo/reviews/?filter=5" target="_blank">'.esc_html__('Rate/Review','buildo').'</a>' ),
	        )
	    ));
